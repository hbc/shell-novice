...
To make it easier to refer to distinct lines, we can add line numbers by typing `:set number`. *Savw the document.* Later, if you choose to remove the line numbers you can type `:set nonumber`.
