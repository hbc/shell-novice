...
Vim is a very powerful text editor, and it offers extensive text editing options. However, in this introduction we are only going to focus on exploring some of the basic functions of it. There is a lot of functionality that we are not going to cover during this session, but encourage you to go further as you become more comfortable using it. 
...
> media. While there are more intuitive editors that are available for use (i.e. [nano](http://www.nano-editor.org/) which is more commonly 
> used with Software Carpentry), most computational scientists tend to favour editors that have greater functionality. 
